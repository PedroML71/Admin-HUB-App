...
import { useGetUnidadeSignupHistoryQuery } from "../../../store/services/hubApi";

const UnidadeGraph = () => {
  const { data: response, isLoading } = useGetUnidadeSignupHistoryQuery();
      ...
      {isLoading ? (
        ...
        <>
          <div className="flex items-center gap-4 p-4 border-b border-b-primary-grey">
            <HomeIcon className="w-16 text-dark-blue" />

            <p className="text-2xl text-dark-blue">Unidades</p>
          </div>
